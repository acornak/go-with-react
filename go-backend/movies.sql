...
(1, 'Drama', current_timestamp, current_timestamp),
(2, 'Crime', current_timestamp, current_timestamp),
(3, 'Action', current_timestamp, current_timestamp),
(4, 'Comic Book', current_timestamp, current_timestamp),
(5, 'Sci-Fi', current_timestamp, current_timestamp),
(6, 'Mystery', current_timestamp, current_timestamp),
(7, 'Adventure', current_timestamp, current_timestamp),
(8, 'Comedy', current_timestamp, current_timestamp),
(9, 'Romance', current_timestamp, current_timestamp);
...
(1,	'The Shawshank Redemption',	'Two imprisoned men bond over a number of years',	1994,	DATE(19941014::TEXT),	142,	5,	'R',	current_timestamp,	current_timestamp),
(2,	'The Godfather',	'The aging patriarch of an organized crime dynasty transfers control to his son',	1972,	DATE(19720324::TEXT),	175,	5,	'R',	current_timestamp,	current_timestamp),
(3,	'The Dark Knight',	'The menace known as the Joker wreaks havoc on Gotham City',	2008,	DATE(20080718::TEXT),	152,	5,	'PG13',	current_timestamp,	current_timestamp),
(4,	'American Psycho',	'A wealthy New York investment banking executive hides his alternate psychopathic ego',	2000,	DATE(20000414::TEXT),	102,	4,	'R',	current_timestamp,	current_timestamp);
...
(9, 4, 2, current_timestamp, current_timestamp),
